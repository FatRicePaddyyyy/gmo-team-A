...
const errorMessages: Record<string, string> = {
  ...
  // レジストリが 403 (sponsoring registrar 以外) を返したとき。ログイン中の会員の
  // 権限ではなく、そのドメインを預かっているレジストラが当社ではない、という意味。
  // 「権限がありません」だと自分のアカウントの問題と誤読されるので、原因を明示する。
  not_sponsored: "このドメインは当社では管理していないため、この操作は行えません。別のレジストラに移管されているか、当社のデータと登録機関の情報が食い違っている可能性があります。サポートまでお問い合わせください。",
