/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: aa7e8d633dfeae6ffd0664d96c5fb0fa)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	REGISTRY_HELLO_CACHE: KVNamespace;
	DB: D1Database;
	BACKEND_URL: "https://backend-production.fatricepaddy.workers.dev" | "http://localhost:8787";
	FRONTEND_URL: "https://frontend-production.fatricepaddy.workers.dev" | "http://localhost:3000";
	crossSubDomainCookies: ".fatricepaddy.workers.dev" | "localhost";
	...
	SECRET_KEY: string;
	KITAQSIGN_BASIC_USER: string;
	KITAQSIGN_BASIC_PASS: string;
	KITAQSIGN_REGISTRAR_ID: string;
	KITAQSIGN_API_KEY: string;
	KITAQNIC_BASIC_USER: string;
	KITAQNIC_BASIC_PASS: string;
	KITAQNIC_REGISTRAR_ID: string;
	KITAQNIC_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_URL" | "FRONTEND_URL" | "crossSubDomainCookies" | "KITAQSIGN_BASE_URL" | "KITAQNIC_BASE_URL" | "KITAQSIGN_FALLBACK_TLDS" | "KITAQNIC_FALLBACK_TLDS" | "BETTER_AUTH_SECRET" | "SECRET_KEY" | "KITAQSIGN_BASIC_USER" | "KITAQSIGN_BASIC_PASS" | "KITAQSIGN_REGISTRAR_ID" | "KITAQSIGN_API_KEY" | "KITAQNIC_BASIC_USER" | "KITAQNIC_BASIC_PASS" | "KITAQNIC_REGISTRAR_ID" | "KITAQNIC_API_KEY">> {}
}
