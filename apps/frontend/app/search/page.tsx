...
import { DomainSearchResult } from "@/components/domain-search-result";
...
export default function SearchPage() {
  const { query, results, search } = useDomainSearch();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <FeatureCards />
      <DomainPriceTable prices={prices} onSelect={() => search("example")} />
