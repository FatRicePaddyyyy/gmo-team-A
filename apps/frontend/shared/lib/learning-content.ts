...
export const ACQUISITION_STEPS: Step[] = [
  ...
  },
  {
    number: 2,
    title: "内容を確認する",
    description: "末尾・初年度と2年目以降の金額・Whois の設定をここで確認します",
  },
  {
    number: 3,
    title: "アカウントを作る",
    description: "メールアドレスとパスワードだけで作れます（すでにお持ちならログイン）",
  },
  {
    number: 4,
    title: "お支払い",
  ...
  },
  {
    number: 5,
    title: "取得完了",
    description: "マイドメインで有効期限・自動更新・Whois の状態を確認できます",
  },
];
...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "有効期限が切れると、サイトもメールも止まります。一定の猶予期間を過ぎるとドメインは削除され、他の人が取得できる状態になります。自動更新をオンにしておくのが確実です。",
  },
  {
    question: "取得すると自分の名前や住所が公開されますか？",
    answer:
      "はい。ドメインを取得すると登録者の氏名・住所・電話番号が Whois という仕組みで公開されます。個人の方は無料の「Whois 情報公開代行」を使うと、あなたの情報の代わりに当社の情報が表示されます。お申し込みの確認画面で設定できます。",
  },
  {
