...
export const ACQUISITION_STEPS: Step[] = [
  ...
  },
  {
    number: 3,
    title: "ログイン",
    description: "アカウントは運営からの発行です。発行されたメールアドレスとパスワードでログインします",
  },
  {
    number: 4,
    title: "お支払い",
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        氏名や住所の代わりに事業者の情報を表示する「公開代行」という仕組みがありますが、このサービスでは提供していません。情報を伏せたい場合は、公開代行を提供している他社のサービスを利用する必要があります。
      </>
    ),
  },
  {
