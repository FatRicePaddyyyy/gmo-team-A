...
/** Whois の説明。取得手続きの中で必ず出す */
export const WHOIS_LESSON = {
  title: "Whois 情報公開について",
  body: "ドメインを取得すると、登録者の氏名・住所・電話番号がインターネット上に公開されます（Whois という仕組みです）。個人の方は「Whois 情報公開代行」を使うと、あなたの情報の代わりに当社の情報が表示されます。",
  option: "Whois 情報公開代行を利用する（無料・個人の方は推奨）",
  caution:
    "一度公開された情報は完全には取り消せません。検索エンジンや第三者のサイトに写しが残ることがあります。申し込む前にここで決めてください。",
} as const;
