...
export const TLD_CATALOG: TldInfo[] = [
  ...
  },
  {
    ...
    firstYearPrice: 0,
    renewalPrice: 1980,
    summary: "利用目的を問わない汎用TLD。情報サイトや個人サイトで広く使われる。",
    audience: "情報発信サイト・個人サイト",
    usage: "2001年から使える古参の汎用TLD",
    detail:
      "「information」に由来する汎用TLDで、用途の制限なく誰でも取得できます。取得しやすく安価なぶん、過去に大量取得によるスパムサイトに使われた経緯もあるため、.com などに比べるとやや事務的な印象を持たれることがあります。",
    limitedOffer: true,
  },
  {
    tld: ".site",
    firstYearPrice: 0,
    renewalPrice: 3520,
    summary: "「サイト」そのものの意味を持つ汎用TLD。安く始めやすい。",
    audience: "個人サイト・ポートフォリオ・お試し",
    usage: "新しいTLDの中では取得数が多いほう",
    detail:
      "「サイト」という単語そのものなので、何のドメインか説明がいりません。初年度は安く始められますが、2年目以降の更新料は .com より高めなので、長く使うつもりなら金額を確認しておきましょう。",
    limitedOffer: true,
  },
  {
    tld: ".online",
    firstYearPrice: 0,
    renewalPrice: 4290,
    summary: "「オンラインの」という意味の汎用TLD。更新料はやや高め。",
    audience: "個人・法人どちらでも",
    usage: "新しいTLDの中でも知名度が高い",
    detail:
      "「オンライン」を前面に出したい人向けの汎用TLDです。初年度は安価なキャンペーン価格で始められますが、2年目以降は .jp に近い水準まで上がるため、更新のタイミングで金額に驚かないよう先に確認してください。",
    limitedOffer: true,
  },
  {
    tld: ".store",
    firstYearPrice: 1980,
    renewalPrice: 4980,
    summary: "ネットショップ向け。ひと目でECサイトと伝わるが更新料は高め。",
    audience: "ネットショップ・EC事業者",
    usage: "海外含めECサイトでの採用が多い",
    detail:
      "「ストア」という単語なので、ネットショップであることがひと目で伝わります。EC向けTLDのため、初年度・更新料ともに一般的なTLDより高めに設定されていることが多く、費用は他の候補と比べてから選んでください。",
  },
  {
    tld: ".tech",
    firstYearPrice: 550,
    renewalPrice: 5478,
    summary: "技術系のスタートアップ・プロダクトで人気。更新料は高め。",
    audience: "スタートアップ・エンジニア・プロダクトサイト",
    usage: "技術系サービスのランディングページで見かける",
    detail:
      "「テック」を前面に出したい技術系のプロダクトやスタートアップに人気のTLDです。初年度は安く試せますが、2年目以降の更新料はこのカタログの中でも高い部類なので、長期利用前提なら他の候補と比較してください。",
  },
  {
    tld: ".space",
    firstYearPrice: 0,
    renewalPrice: 2178,
    summary: "クリエイティブ系・趣味のサイトで人気。安く始めやすい。",
    audience: "趣味のサイト・クリエイター・コミュニティ",
    usage: "新しいTLDの中では比較的よく使われる",
    detail:
      "「スペース（場所・空間）」という意味の汎用TLDで、クリエイティブ系や趣味のサイトでよく選ばれます。取得条件はなく、価格も抑えめなので気軽に試しやすい末尾です。",
    limitedOffer: true,
  },
  {
    tld: ".fun",
    firstYearPrice: 0,
    renewalPrice: 2178,
    summary: "カジュアルな響きで趣味・イベントサイト向け。安く始めやすい。",
    audience: "趣味のサイト・イベント・お試し",
    usage: ".xyz と同じく新しいTLDの中では安価な部類",
    detail:
      "名前の通りカジュアルな響きで、趣味のサイトやイベント告知向きです。.xyz と同様に新しいTLDのため取得しやすく安価な一方、送ったメールが迷惑メール扱いされることがある点は同じように注意してください。",
    limitedOffer: true,
  },
];
